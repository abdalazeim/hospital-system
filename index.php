  ...
  <body class="align">
    ...
    <div class="grid">
      ...
      <form action="check.php" method="POST" class="form login">
        ...
        <div class="form__field">
          <input type="submit" action="new.html" value="Sign In">
...
<div id="su">
<ul>
<li> <a href="do.htbml"a>نسية كلمة السر</a></li>
<li> <a href="new.html"a>انشاء مستخدم جديد</a></li>
<li> <a href="admin/homeadmin.html"a>الدخول كمسؤول</a></li>
<li> <a href="admin.php"a>تجربة النظام</a></li>
